...
|---|---|
| [OrderedStructures](concepts/Lax751879/OrderedStructures.lean) | Finite relational vocabularies, ordered structures, and queries with k distinguished elements. |
| [LeastFixedPoints](concepts/Lax751879/LeastFixedPoints.lean) | Least fixed point of a monotone relation operator; convergence after at most the number of possible tuples. |
| [FixedPointSyntax](concepts/Lax751879/FixedPointSyntax.lean) | FO(LFP) with arbitrary nesting and parameters; every bound relation occurs positively in its defining body. |
| [FixedPointSemantics](concepts/Lax751879/FixedPointSemantics.lean) | Satisfaction and definability; the obligation that syntactic positivity implies monotonicity. |
| [StructureEncoding](concepts/Lax751879/StructureEncoding.lean) | Unary domain size, dense characteristic tables, and distinguished tuple; injectivity and exact length. |
| [PolynomialTime](concepts/Lax751879/PolynomialTime.lean) | A concrete finite Turing machine decides the encoded query language in polynomial time and rejects malformed inputs. |
| [FixedPointEvaluation](concepts/Lax751879/FixedPointEvaluation.lean) | Every fixed FO(LFP) formula has a polynomial-time evaluator. |
| [ImmermanVardi](concepts/Lax751879/ImmermanVardi.lean) | Every polynomial-time query is FO(LFP)-definable, and the resulting equivalence. |
