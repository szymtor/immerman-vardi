...
namespace Lax751879Proofs.CompiledRun
...
noncomputable def closure (tm : FinTM2) (e : tm.Γ tm.k₀ ≃ Bool) {σ : Vocabulary} {m : Nat}
  ...
  Lax751879.LeastFixedPoints.leastFixedPoint (ParameterizedRules.operator (rules tm e σ m d) A.structureValue A.tuple)
...
end Lax751879Proofs.CompiledRun
