...
namespace Lax979537Proofs.ImmermanVardi
...
/--
---
conclusion: Lax979537.ImmermanVardi.ptimeDefinable
---
...
theorem ptimeDefinable {σ : Vocabulary} {k : Nat} (Q : Query σ k) (hQ : InP Q) : Definable Q := by
  ...
  let φ : Lax979537.FixedPointSyntax.Formula σ k :=
  ...
  have heval : Satisfies A φ ↔ f (Lax979537.StructureEncoding.encode A) = true :=
  ...
  · rintro ⟨B, he, hb⟩
    have hBA := Lax979537Proofs.StructureEncoding.encodeInjective σ k he
    subst B
    exact hb

/--
---
conclusion: Lax979537.ImmermanVardi.capturesPtime
---
...
end Lax979537Proofs.ImmermanVardi
