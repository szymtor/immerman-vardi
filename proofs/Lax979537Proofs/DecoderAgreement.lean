...
namespace Lax979537Proofs.DecoderAgreement
...
theorem finite_agree (σ : Lax979537.OrderedStructures.Vocabulary) (k : Nat) (xs : List Bool) :
...
theorem finite_validity (σ : Lax979537.OrderedStructures.Vocabulary) (k : Nat) (xs : List Bool) :
...
theorem accepts_iff_encoding (σ : Lax979537.OrderedStructures.Vocabulary) (k : Nat) (xs : List Bool) :
    (StackDecoder.result (FiniteDecoder.layout σ k) (FiniteDecoder.inputStore σ k xs)).state.1.2 = true ↔
      ∃ A : Lax979537.OrderedStructures.PointedStructure σ k, Lax979537.StructureEncoding.encode A = xs := by
  rw [finite_validity]
  constructor
  · intro h
...
theorem finite_data (σ : Lax979537.OrderedStructures.Vocabulary) (k : Nat) (xs : List Bool)
    (A : Lax979537.OrderedStructures.PointedStructure σ k) (hd : Decoding.decode σ k xs = some A) :
...
end Lax979537Proofs.DecoderAgreement
