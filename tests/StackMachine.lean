...
def unaryMachine : FinTM2 :=
  machine (Lax751879Proofs.StackUnary.parse (Aux := Unit) false true) false true ((), none)
...
#print axioms Lax751879Proofs.StackProgram.compile_correct
#print axioms Lax751879Proofs.StackProgram.program_polytime
#print axioms Lax751879Proofs.StackTransfer.transfer_executes
#print axioms Lax751879Proofs.StackTransfer.reverse_polytime
#print axioms Lax751879Proofs.StackUnary.parse_executes
#print axioms Lax751879Proofs.StackUnary.splitUnary_correct

def copyProgram : BitProgram (Fin 4) Unit := Lax751879Proofs.StackCopy.copy 0 1 2
def copyMachine : FinTM2 := machine copyProgram 0 1 ((), none)

def checkCopy (xs ys : List Bool) : Bool :=
  let s := Lax751879Proofs.StackCopy.working3 (fun _ : Fin 4 => [false, true])
...
def repeatProgram : BitProgram Bool Unit :=
  Lax751879Proofs.StackRepeat.repeatCount false
...
def compareProgram : BitProgram (Fin 3) (Unit × Bool) :=
  Lax751879Proofs.StackCompare.less 0 1
...
def lookupProgram : BitProgram (Fin 3) (Unit × Option Bool) :=
  Lax751879Proofs.StackLookup.lookup 0 1
...
#print axioms Lax751879Proofs.StackCopy.copy_executes
#print axioms Lax751879Proofs.StackRepeat.repeat_executes
#print axioms Lax751879Proofs.StackRepeat.result_spec
#print axioms Lax751879Proofs.StackClear.clear_store
#print axioms Lax751879Proofs.StackCompare.less_executes
#print axioms Lax751879Proofs.StackLookup.lookup_executes

def powerProgram (k : Nat) : BitProgram (Fin 7) Unit :=
  Lax751879Proofs.StackPower.power 0 1 2 (([3, 4, 5] : List (Fin 7)).take k)
...
#guard (List.range 4).all fun k => (List.range 4).all fun n =>
  ...
  let fuel := Lax751879Proofs.StackPower.cost k n
...
#print axioms Lax751879Proofs.StackCopy.copy_store
#print axioms Lax751879Proofs.StackPower.power_executes

def decoderWorkspace : Lax751879Proofs.StackReadRelations.Workspace (Fin 11) where
  domain := 0
  input := 1
  count := 2
  tmp := 3
...
def relationsProgram : BitProgram (Fin 11) (Unit × Bool) :=
  Lax751879Proofs.StackReadRelations.readTables decoderWorkspace [(0, 7), (1, 8), (2, 9)]
...
def checkRelations (n : Nat) (bits : List Bool) (valid : Bool) : Bool :=
  ...
  let fuel := Lax751879Proofs.StackReadTable.cost 0 n +
    Lax751879Proofs.StackReadTable.cost 1 n + Lax751879Proofs.StackReadTable.cost 2 n + 1
  ...
  c.l.isNone && eqBits (c.stk (0 : Fin 11)) (List.replicate n true) &&
    ...
    eqBits (c.stk (7 : Fin 11)) (Lax751879Proofs.StackTake.paddedPrefix 1 bits) &&
    eqBits (c.stk (8 : Fin 11)) (Lax751879Proofs.StackTake.paddedPrefix n (bits.drop 1)) &&
    eqBits (c.stk (9 : Fin 11)) (Lax751879Proofs.StackTake.paddedPrefix (n ^ 2) (bits.drop (1 + n))) &&
...
def coordProgram : BitProgram (Fin 7) ((Unit × Bool) × Bool) :=
  Lax751879Proofs.StackCoordinate.parse 0 1 2 3 4 5
...
def checkCoord (n : Nat) (bits : List Bool) (valid : Bool) : Bool :=
  ...
  let r := Lax751879Proofs.StackUnary.splitUnary bits
...
#print axioms Lax751879Proofs.StackTake.takeBits_store
#print axioms Lax751879Proofs.StackReadTable.readTable_executes
#print axioms Lax751879Proofs.StackReadRelations.readTables_executes
#print axioms Lax751879Proofs.StackCheckedUnary.parse_executes
#print axioms Lax751879Proofs.StackCheckBound.checkBound_executes
#print axioms Lax751879Proofs.StackCoordinate.parse_executes

def endProgram : BitProgram Bool (Unit × Bool) := Lax751879Proofs.StackCheckedUnary.checkEnd false
...
#print axioms Lax751879Proofs.StackCheckedUnary.checkEnd_executes
